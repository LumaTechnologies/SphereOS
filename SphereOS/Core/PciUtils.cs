namespace SphereOS.Core
{
    internal static class PciUtils
    {
        public static string GetVendorName(ushort id)
        {
            ...
            if (id == 0x051D) return "American Power Conversion";
            ...
            if (id == 0x100A) return "AV Chaseway, Ltd.";
            ...
            if (id == 0x10D2) return "Molex Inc.orporated";
            ...
            if (id == 0x1414) return "Microsoft Corporation";
